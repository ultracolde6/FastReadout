...
architecture STRUCTURE of system_frequency_counter_0_0_frequency_counter is
  ...
  signal \state_next1_inferred__0/i__carry__0_n_1\ : STD_LOGIC;
  ...
  signal \NLW_state_next1_inferred__0/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\counter_output_next_reg[31]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\counter_output_next_reg[31]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\counter_output_next_reg[31]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\counter_output_next_reg[31]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state_next1_carry__0_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\state_next1_carry__0_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\state_next1_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_state_next1_inferred__0/i__carry__0_CO_UNCONNECTED\(3),
      CO(2) => \state_next1_inferred__0/i__carry__0_n_1\,
      CO(1) => \state_next1_inferred__0/i__carry__0_n_2\,
      CO(0) => \state_next1_inferred__0/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => S_AXIS_IN_tdata(13),
      DI(1 downto 0) => B"00",
