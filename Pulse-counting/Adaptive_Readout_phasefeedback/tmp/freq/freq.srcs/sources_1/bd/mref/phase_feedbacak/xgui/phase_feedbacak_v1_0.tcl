...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "HIGH_THRESHOLD_2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "LOW_THRESHOLD" -parent ${Page_0}
  ipgui::add_param $IPINST -name "LOW_THRESHOLD_2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PULSE_DURATION" -parent ${Page_0}
  ipgui::add_param $IPINST -name "nancilla" -parent ${Page_0}
  ipgui::add_param $IPINST -name "natom" -parent ${Page_0}
  ipgui::add_param $IPINST -name "nph" -parent ${Page_0}
...
proc update_PARAM_VALUE.HIGH_THRESHOLD_2 { PARAM_VALUE.HIGH_THRESHOLD_2 } {
	# Procedure called to update HIGH_THRESHOLD_2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.HIGH_THRESHOLD_2 { PARAM_VALUE.HIGH_THRESHOLD_2 } {
	# Procedure called to validate HIGH_THRESHOLD_2
	return true
}
...
proc update_PARAM_VALUE.LOW_THRESHOLD_2 { PARAM_VALUE.LOW_THRESHOLD_2 } {
	# Procedure called to update LOW_THRESHOLD_2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LOW_THRESHOLD_2 { PARAM_VALUE.LOW_THRESHOLD_2 } {
	# Procedure called to validate LOW_THRESHOLD_2
	return true
}
...
proc update_PARAM_VALUE.nancilla { PARAM_VALUE.nancilla } {
	# Procedure called to update nancilla when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.nancilla { PARAM_VALUE.nancilla } {
	# Procedure called to validate nancilla
	return true
}

proc update_PARAM_VALUE.natom { PARAM_VALUE.natom } {
	# Procedure called to update natom when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.natom { PARAM_VALUE.natom } {
	# Procedure called to validate natom
	return true
}

proc update_PARAM_VALUE.nph { PARAM_VALUE.nph } {
	# Procedure called to update nph when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.nph { PARAM_VALUE.nph } {
	# Procedure called to validate nph
	return true
}
...
proc update_MODELPARAM_VALUE.HIGH_THRESHOLD_2 { MODELPARAM_VALUE.HIGH_THRESHOLD_2 PARAM_VALUE.HIGH_THRESHOLD_2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.HIGH_THRESHOLD_2}] ${MODELPARAM_VALUE.HIGH_THRESHOLD_2}
}

proc update_MODELPARAM_VALUE.LOW_THRESHOLD_2 { MODELPARAM_VALUE.LOW_THRESHOLD_2 PARAM_VALUE.LOW_THRESHOLD_2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LOW_THRESHOLD_2}] ${MODELPARAM_VALUE.LOW_THRESHOLD_2}
}
...
proc update_MODELPARAM_VALUE.nancilla { MODELPARAM_VALUE.nancilla PARAM_VALUE.nancilla } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nancilla}] ${MODELPARAM_VALUE.nancilla}
}

proc update_MODELPARAM_VALUE.nph { MODELPARAM_VALUE.nph PARAM_VALUE.nph } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nph}] ${MODELPARAM_VALUE.nph}
}

proc update_MODELPARAM_VALUE.natom { MODELPARAM_VALUE.natom PARAM_VALUE.natom } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.natom}] ${MODELPARAM_VALUE.natom}
}
