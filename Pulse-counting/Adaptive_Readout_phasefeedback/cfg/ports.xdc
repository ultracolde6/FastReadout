...
set_property PACKAGE_PIN H16 [get_ports {pulse}]
set_property PACKAGE_PIN H17 [get_ports {pulse_check}]
set_property PACKAGE_PIN J18 [get_ports {state2}]
set_property PACKAGE_PIN H18 [get_ports {exp_n_tri_io[2]}]
set_property PACKAGE_PIN K17 [get_ports {state}]
set_property PACKAGE_PIN K18 [get_ports {exp_n_tri_io[3]}]
set_property PACKAGE_PIN L14 [get_ports output_ttl]
...
set_property IOSTANDARD LVCMOS33 [get_ports output_ttl]
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports pulse_check]
