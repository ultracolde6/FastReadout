...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../freq.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../freq.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"../../../../freq.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../freq.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
