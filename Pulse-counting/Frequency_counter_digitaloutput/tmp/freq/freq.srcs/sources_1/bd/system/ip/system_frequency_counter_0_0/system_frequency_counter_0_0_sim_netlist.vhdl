...
--               readout/FastReadout/Pulse-counting/Frequency_counter_digitaloutput/tmp/freq/freq.srcs/sources_1/bd/system/ip/system_frequency_counter_0_0/system_frequency_counter_0_0_sim_netlist.vhdl}
...
architecture STRUCTURE of system_frequency_counter_0_0_frequency_counter is
  ...
  signal \NLW_state_next1__6_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
state_i_1: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => rst,
      I1 => state,
      I2 => \state_next1__6_carry__0_n_3\,
...
\state_next1__6_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_state_next1__6_carry__0_CO_UNCONNECTED\(3 downto 1),
      ...
      S(3 downto 1) => B"000",
      S(0) => \state_next1__6_carry__0_i_1_n_0\
    );
...
\state_next1__6_carry_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
