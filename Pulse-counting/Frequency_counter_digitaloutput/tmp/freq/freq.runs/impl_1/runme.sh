...
HD_PWD='C:/Users/Purcell/Documents/RedPitayaProjects/adaptive readout/FastReadout/Pulse-counting/Frequency_counter_digitaloutput/tmp/freq/freq.runs/impl_1'
cd "$HD_PWD"
